...
public class TheaterVO {
	...
	public TheaterVO(int ttr_no, String com_id, String ttr_cat,
			...
			String[] files, String ttr_ss, String[] seat_id, String[] seat_grd,
			int[] seat_no, int[] seat_pri, Date[] seat_date, Date[] seat_time) {
		super();
		this.ttr_no = ttr_no;
		this.com_id = com_id;
	...
	public String toString() {
		return "TheaterVO [ttr_no=" + ttr_no + ", com_id=" + com_id
				...
				+ Arrays.toString(files) + ", ttr_ss=" + ttr_ss + ", seat_id="
